...
<%
	...
	String TABLE_TYPE="進貨";
	String ACCOUNT_ACTION="付";
	String PRICE_ACTION_NAME="進";
	String ITEM_ACTION_NAME="發";
	String UNIT_NAME_COL="出貨單位";
	String UNIT_PHONE_COL="電話";
	String TABLE_CLASS="B"; //銷貨、銷退為class A，進貨、進退為class B。兩類不同處為發貨、送貨相反  (銷貨<->供貨)
